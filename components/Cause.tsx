...
export function Cause() {
  return (
    <section id="cause" className="grid sm:grid-cols-2">
      <div className="bg-teal p-10 sm:p-14 flex flex-col items-start">
        <Image
          src={images.washIp}
        ...
        />
        <p className="font-heading text-2xl text-ink-900 mb-3">
      ...
      <div className="bg-pink-600 p-10 sm:p-14 flex flex-col items-start">
        <Image
          ...
          className="h-10 w-auto mb-5"
        />
        <p className="font-heading text-2xl text-cream-100 mb-3">
      ...
      <div className="col-span-full bg-ink-900 p-8 flex justify-center">
        <div className="border border-dashed border-yellow p-5 max-w-3xl">
          <p className="font-tag uppercase text-xs tracking-wide text-yellow mb-1">
            Needs Client Input
          </p>
